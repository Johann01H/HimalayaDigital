                        ...
                        columns:  [
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    ...
                                    var urlServicio = "{{ url('superadmin/verServicio') }}";
                                    return `
                                    <a href="${baseUrl}/$" class="btn btn-primary">Ver servicio</a>
                                    <a href="${baseUrl}/${data.id}" class="btn btn-secondary text-white">Editar servicio</a>
                                    `;
                                }
                            },
