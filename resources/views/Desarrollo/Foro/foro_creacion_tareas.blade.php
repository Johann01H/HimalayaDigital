...
@section('template-blank-development')
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <p><span class="text-danger px-1">*</span>Nombre del proyecto</p>
                    <select class="custom-select2 form-control pt-5" name="state" style="width: 100%; height: 38px;">
                ...
                <div class="col-md-6 mt-5">
                    <ul>
                        <li class="pb-3"><strong class="text-primary pb-2">Numero de OT:</strong>1234-234</li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="container">
                        <div class="row pb-4">
                            <div class="custom-control custom-radio mb-5 pr-2 ">
            ...
            <div class="button-group d-flex justify-content-center">
                <button class="btn btn-success mx-3 col-3 ">Agregar tarea</button>
                <button class="btn btn-primary rounded mx-3 col-3 ">Publicar tarea</button>
            </div>
        </div>
    </div>
@endsection
